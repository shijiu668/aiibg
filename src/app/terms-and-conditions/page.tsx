                ...
                <div className="space-y-8 w-full text-left">
                    ...
                    <div className="result-container">
                        ...
                        <p className="text-gray-700 mb-4 leading-relaxed">
                            This Service is operated by <strong>Yuan Mingxi</strong> trading as AI Italian Brainrot Generator, accessible from italianbrainrots.org. All references to "the Company," "we," "us," or "our" in this Agreement refer to Yuan Mingxi and AI Italian Brainrot Generator.
                        </p>
                    </div>
                    ...
                    <div className="result-container">
                        ...
                        <p className="text-gray-700 mb-4 leading-relaxed">
                            AI Italian Brainrot Generator is an online platform operated by Yuan Mingxi that provides AI-powered content generation services, including:
                        </p>
                        <ul className="list-disc list-inside text-gray-700 space-y-2">
                            <li>Generation of abstract Italian Brainrot style artwork, surreal text, and stylized voice content (no human faces, characters, or realistic representations)</li>
                            <li>PDF to Brainrot content transformation</li>
                            <li>Voice generation and translation tools for entertainment purposes</li>
                    ...
                    <div className="result-container">
                        <h2 className="text-2xl font-bold mb-4 gradient-text">Content Generation Limitations</h2>

                        <h3 className="text-lg font-semibold mb-3 text-gray-800">Prohibited Generation</h3>
                        <p className="text-gray-700 mb-4 leading-relaxed">
                            Our AI generation services are designed to create abstract, surreal artwork for entertainment purposes only. We strictly prohibit and do not support the generation of:
                        </p>
                        <ul className="list-disc list-inside text-gray-700 space-y-2">
                            <li>Human faces, realistic human characters, or human-like representations</li>
                            <li>Face swaps, deepfakes, or any content intended for impersonation</li>
                            <li>Voice impersonations of real individuals</li>
                            <li>Content that could be used for deceptive or fraudulent purposes</li>
                            <li>Any content that violates third-party rights or applicable laws</li>
                        </ul>

                        <h3 className="text-lg font-semibold mb-3 text-gray-800">Generated Content Characteristics</h3>
                        <p className="text-gray-700 mb-4 leading-relaxed">
                            All content generated by our platform consists of abstract, surreal artwork in the distinctive "Italian Brainrot" aesthetic style, focusing on objects, food items, abstract shapes, and artistic interpretations that do not represent real individuals or contain identifying features.
                        </p>
                    </div>
