            ...
            <nav className="w-full bg-white/80 backdrop-blur-sm shadow-sm sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 py-3">
                    <div className="flex justify-between items-center">
                        <Link href="/" className="text-xl font-bold gradient-text-orange">
                            AI Italian Brainrot
                        </Link>
                        <div className="flex space-x-6">
                            ...
                            <Link href="/italian-brainrot-generator" className="text-gray-700 hover:text-orange-600 transition-colors">
                                Italian Brainrot Generator 2.0
                            </Link>
                            <Link href="/pdf-to-brainrot" className="text-orange-600 font-medium">
                                PDF to Brainrot
                            </Link>
                            <Link href="/italian-brainrot-clicker" className="text-gray-700 hover:text-orange-600 transition-colors">
