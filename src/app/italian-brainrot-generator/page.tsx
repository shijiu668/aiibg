            ...
            <div className="z-10 max-w-7xl w-full px-4 py-8">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-3xl mx-auto">
                        Experience the ultimate Italian Brainrot Generator with AI-powered content creation. Generate authentic Italian Brainrot abstract artwork, surreal text, and immersive audio content in seconds.
                    </p>
                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-6 border border-orange-100">
                            ...
                            <ul className="space-y-2 text-sm text-gray-700">
                                ...
                                <li className="flex items-start">
                                    <span className="text-orange-500 mr-2">•</span>
                                    The Body Fusion Generator creates impossible 3D abstract objects automatically
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                >
                                    {imageLoading ? (
                                        <div className="text-center">
                                            ...
                                            <p className="text-orange-600 mt-3">Creating Italian Brainrot artwork...</p>
                                        </div>
                                    ) : imageError ? (
                                        ...
                                        <img
                                            src={imageUrl}
                                            alt="Generated Italian Brainrot Artwork"
                                        ...
                                        <p className="text-gray-500">Your Italian Brainrot artwork will appear here</p>
                                    )}
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                        <div className="bg-white rounded-2xl p-8 shadow-xl border-2 border-orange-200 hover:border-orange-300 transition-all duration-300">
                            ...
                            <h2 className="text-2xl font-bold mb-4 text-orange-700">3D Abstract Artwork Creation</h2>
                            <p className="text-gray-600 leading-relaxed">
                                The Italian Brainrot Generator creates stunning abstract 3D artwork with the signature exaggerated features, vibrant colors, and surreal proportions that define the Italian Brainrot aesthetic. Each artwork generated by our Italian Brainrot Generator is unique and captures the whimsical essence of this viral art style.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            <div>
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    Every output from our Italian Brainrot Generator maintains the characteristic hyperrealistic 3D rendering style, abstract features, and vibrant color palettes...
                                </p>
                            </div>
                            <div>
