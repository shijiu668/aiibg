      ...
      <footer className="w-full bg-white py-8 mt-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center text-gray-500 text-sm">
            ...
            <div className="my-6">
              <p className="text-gray-600 text-sm mb-3">Connect With Developer & Support</p>
              <div className="flex flex-wrap justify-center gap-3">
                <a
                  href="https://climate.stripe.com/0kD62M"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white text-sm font-medium rounded-lg hover:shadow-md transition-all shadow-sm"
                >
                ...
                <a
                  href="https://ramen.tools/@Echo345"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-4 py-2 bg-orange-500 text-white text-sm font-medium rounded-lg hover:bg-orange-600 transition-colors shadow-sm"
                >
                ...
                <a
                  href="https://bento.me/nano-banana-photoshop-script"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://dev.to/qian_yuan_d864273b2aea665"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-4 py-2 bg-gray-800 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors shadow-sm"
                >
                  <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
