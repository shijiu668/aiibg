...
<div className="space-y-8 w-full" style={{ marginTop: "2rem" }}>
  <div className="result-container">
    ...
    {(imageUrl || text || audioUrl || imageLoading || textLoading || audioLoading ||
      ...
      <div className="flex justify-center items-center bg-gray-50 rounded-lg" style={{ height: "200px", marginTop: "1.5rem" }}>
        <p className="text-gray-400">Click "Start generating" to create your Italian Brainrot content</p>
      </div>
    )}
  </div>
</div>
