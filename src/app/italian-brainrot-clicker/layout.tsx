...
export const metadata: Metadata = {
  ...
  description: "Play the ultimate Italian Brainrot Clicker game! Click your way through surreal Italian Brainrot adventures. Free Italian Brainrot Clicker with endless fun and viral Italian characters.",
  ...
  openGraph: {
    title: "Italian Brainrot Clicker",
    description: "Experience the most addictive Italian Brainrot Clicker game! Click through surreal Italian adventures with viral characters. Play Italian Brainrot Clicker free in your browser.",
